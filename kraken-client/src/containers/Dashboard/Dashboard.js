                    ...
                    <Form onSubmit={this.addCrunchParameter}>
                        <Form.Group className={classes.formGroup}>
                            ...
                            <Row>
                                ...
                                <Col sm="6">
                                    <Form.Control name="characters" type="text" list="character-options" placeholder="charset (options ↓)" required />
                                    <datalist id="character-options">
                                        <option value="0123456789">Numbers (123...)</option>
                                        <option value="ABCDEFGHIJKLMNOPQRSTUVWXYZ">Upper Case (ABC...)</option>
                                        <option value="abcdefghijklmnopqrstuvwxyz">Lower Case (abc...)</option>
                                        <option value="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz">Upper Case + Lower Case</option>
                                        <option value="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789">Upper Case + Lower Case + Numbers</option>
